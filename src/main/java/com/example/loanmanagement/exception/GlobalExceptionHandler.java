...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(InvalidLoanTransitionException.class)
    public ResponseEntity<Map<String, String>> handleInvalidTransition(InvalidLoanTransitionException ex) {
